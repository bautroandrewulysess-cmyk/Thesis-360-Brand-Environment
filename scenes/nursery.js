...
// NURSERY SCENE
// ============================================================================
// Loads and renders the nursery Gaussian splat with WASD movement
...
class NurseryScene extends Scene {
    constructor() {
        ...
        this.collisionBoxes = [
            { name: 'nursery-box-1', pos: [-0.325, 1.140, 0.965], size: [21.402, 0.656, 0.116], rotY: -9.5 },
            { name: 'nursery-box-2', pos: [0.290, 1.140, -0.930], size: [21.402, 0.656, 0.116], rotY: -9.5 },
            { name: 'nursery-box-3', pos: [10.050, 1.260, 10.470], size: [21.402, 0.656, 0.116], rotY: -90.5 },
            { name: 'nursery-box-4', pos: [-9.810, 1.200, 0.990], size: [21.402, 0.656, 0.116], rotY: -90.5 },
        ];
    ...
    setupEditorPanelListeners() {
        ...
        if (deleteBtn && !deleteBtn.classList.contains('nursery-bound')) {
            deleteBtn.classList.add('nursery-bound');
    ...
    async onLoad() {
        ...
        try {
            ...
            this.splatAsset = new pc.Asset('nursery-splat', 'gsplat', {
                url: 'Assets/Gaussian Splat/thesisNursery.sog'
            });
            ...
            await new Promise((resolve) => {
                this.splatAsset.ready(() => {
                    this.splatEntity = new pc.Entity('nursery-splat');
            ...
            const startAudioOnInteraction = () => {
                this.initAmbient('Assets/Music/nurseryAmbienceSound.mp3', 0.5);
...
// Register and create the nursery scene
const nurseryScene = new NurseryScene();
sceneManager.registerScene('nursery', nurseryScene);
